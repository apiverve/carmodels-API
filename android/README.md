...
```gradle
dependencies {
    implementation 'com.github.apiverve:carmodels-api:1.1.12'
}
```
...
CarModelsAPIClient client = new CarModelsAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/carmodels](https://docs.apiverve.com/ref/carmodels)
...
- **Documentation:** [https://docs.apiverve.com/ref/carmodels](https://docs.apiverve.com/ref/carmodels)
- **Issues:** [GitHub Issues](https://github.com/apiverve/carmodels-api/issues)
